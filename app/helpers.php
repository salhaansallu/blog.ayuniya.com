...
{
    return "https://store.ayuniya.com/category/" . $cat_id . '/' . str_replace(' ', '-', strtolower($cat_name));
}

function validate_image($url)
{
    if (file_exists(public_path('../../image.ayuniya.com/products/' . $url))) {
        return 'https://image.ayuniya.com/products/' . $url;
    } else {
...
{
    //Cookie::make('redirectAfterLogin', request()->getRequestUri(), (60*24));
