        ...
        <div class="container">
            <div class="row row-cols-1 row-cols-xl-3 row-cols-lg-3 row-cols-md-3 row-cols-sm-2">
                ...
                <div class="col">
                    ...
                    <ul>
                        <li><a href="https://store.ayuniya.com/">Home</a></li>
                        <li><a href="https://store.ayuniya.com/appointment">Service</a></li>
                        <li><a href="https://store.ayuniya.com/shop">Shop</a></li>
                        <li><a href="https://store.ayuniya.com/about-us">About Us</a></li>
                        <li><a href="https://store.ayuniya.com/privacy_policy">Privacy Policy</a></li>
                        <li><a href="https://store.ayuniya.com/Return_Policy">Return Policy</a></li>
                        <li><a href="https://store.ayuniya.com/Terms_And_Condition">Terms And Condition</a></li>
                        @guest
                            <li><a href="https://store.ayuniya.com/login">Login/Register</a></li>
                        @else
                            <li><a href="https://store.ayuniya.com/account">Account</a></li>
                        @endguest
                    </ul>
                </div>
                ...
                <div class="col">
                    ...
                    <ul>
                        <li><a href="https://store.ayuniya.com/about-us/#Conatct">Contact Us</a></li>
                    </ul>
